...
import SubscriptionManagementClient from '@/components/subscriptions/subscription-management-client';
...
export default async function SubscriptionManagementPage() {
  ...
  return (
    <ContentLayout userInfo={user} title='Subscription Management'>
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
