...
import { AccountMainData } from '@/components/account';
...
export default function AccountPage() {
  ...
  return (
    <ContentLayout userInfo={user} title='Account'>
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage className='text-fg-default'>Account</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
