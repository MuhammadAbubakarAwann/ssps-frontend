...
export function StudentDetailsMainData() {
  ...
  useEffect(() => {
    ...
    const fetchClasses = async () => {
      try {
        ...
        const response = await fetch('/api/teacher/classes/names-short', {
          method: 'GET',
          headers: { 'Content-Type': 'application/json' }
        });
  ...
  useEffect(() => {
    ...
    const fetchStudents = async () => {
      try {
        ...
        const response = await fetch(`/api/teacher/classes/${selectedClassId}/students/prediction-status-aggregated`, {
          method: 'GET',
          headers: { 'Content-Type': 'application/json' }
        });
